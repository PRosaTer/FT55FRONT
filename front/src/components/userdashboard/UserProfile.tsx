    ...
    <div>
      {isEditing ? (
        ...
        <div className="mt-4 sm:mt-0 sm:ml-5 flex flex-col items-center sm:items-start">
          ...
          {user?.DOB && (
            <p className="text-sm sm:text-base">
              <span className="font-semibold">Fecha de Nacimiento:</span> {new Date(user.DOB).toLocaleDateString("es-ES")}
            </p>
          )}
          {user?.dni && (
            <p className="text-sm sm:text-base">
          ...
          {user?.civilStatus && (
            <p className="text-sm sm:text-base">
              <span className="font-semibold">Estado Civil:</span> {user.civilStatus}
            </p>
          )}
          {user?.employmentStatus && (
            <p className="text-sm sm:text-base">
              <span className="font-semibold">Estado laboral:</span> {user.employmentStatus}
            </p>
          )}
          {user?.phone && (
            <p className="text-sm sm:text-base">
