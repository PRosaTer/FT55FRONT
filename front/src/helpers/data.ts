...
export const productsToPreLoad = [
  {
    ...
    isAvailable: true,
    capacity: 8,
    photos: ["/images/casa1.jpg", "/images/dentro1.jpg"],
    checkin: "2024-12-20",
    checkout: "2024-12-27",
    rating: 4.8,
  },
  {
    ...
    isAvailable: true,
    capacity: 4,
    photos: ["/images/casa2.jpg", "/images/dentro2.jpg"],
    checkin: "2024-12-15",
    checkout: "2024-12-22",
    rating: 4.6,
  },
  {
    ...
    isAvailable: true,
    capacity: 6,
    photos: ["/images/casa3.jpg", "/images/dentro3.jpg"],
    checkin: "2024-12-10",
    checkout: "2024-12-17",
    rating: 4.9,
  },
  {
    ...
    isAvailable: false,
    capacity: 2,
    photos: ["/images/casa4.jpg", "/images/dentro4.jpg"],
    checkin: "2024-12-05",
    checkout: "2024-12-12",
    rating: 4.7,
  },
  {
    ...
    isAvailable: true,
    capacity: 5,
    photos: ["/images/casa5.jpg", "/images/dentro5.jpg"],
    checkin: "2024-12-08",
    checkout: "2024-12-15",
    rating: 4.5,
  },
  {
    ...
    isAvailable: true,
    capacity: 10,
    photos: ["/images/casa6.jpg", "/images/dentro6.jpg"],
    checkin: "2024-12-18",
    checkout: "2024-12-25",
    rating: 4.9,
  },
  {
    ...
    isAvailable: false,
    capacity: 4,
    photos: ["/images/casa7.jpg", "/images/dentro7.jpg"],
    checkin: "2024-12-01",
    checkout: "2024-12-07",
    rating: 4.8,
  },
  {
    ...
    isAvailable: true,
    capacity: 5,
    photos: ["/images/casa8.jpg", "/images/dentro8.jpg"],
    checkin: "2024-12-12",
    checkout: "2024-12-20",
    rating: 4.7,
  },
  {
    ...
    isAvailable: true,
    capacity: 6,
    photos: ["/images/casa9.jpg", "/images/dentro9.jpg"],
    checkin: "2024-12-22",
    checkout: "2024-12-29",
    rating: 5.0,
  },
